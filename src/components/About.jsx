...
const About = () => {
  return (
    <>
      ...
      >
        <div
          className="WRAPPER mt-12 flex max-sm:flex-col gap-5"
          style={{ justifyContent: "space-between" }}
        >
          <div
            style={{ marginTop: "50px" }}
            className="INTRO text-[70px] leading-[80px] font-semibold max-sm:text-[50px] max-sm:leading-[70px] max-sm:font-semibold"
          >
